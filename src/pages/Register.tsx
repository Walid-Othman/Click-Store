...
function handelsetshow(){
    ...
    return(
        ...
        <form className="w-full !mx-auto h-auto flex items-center justify-center flex-col gap-8 bg-gray-900 rounded-lg !py-10 " action="">
            ...
            <p className="text-white">Do you have an acount?</p> 
            <Link className="text-gray-300 border-b-2 border-b-cyan-400 !pb-1 hover:border-b-cyan-700" to={'/logIn'}>LogIn</Link>
            </div>
            <Button className="!text-white w-1/3" variant="outlined">Sign Up</Button>
